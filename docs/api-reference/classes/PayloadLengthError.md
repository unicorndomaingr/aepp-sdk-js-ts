[api-reference](../README.md) / PayloadLengthError

# Class: PayloadLengthError
...
- [constructor](PayloadLengthError.md#constructor)

### Properties

- [message](PayloadLengthError.md#message)
- [name](PayloadLengthError.md#name)
- [stack](PayloadLengthError.md#stack)
- [prepareStackTrace](PayloadLengthError.md#preparestacktrace)
- [stackTraceLimit](PayloadLengthError.md#stacktracelimit)

### Methods

- [captureStackTrace](PayloadLengthError.md#capturestacktrace)

## Constructors

### constructor

• **new PayloadLengthError**(`message`)
...
[src/utils/errors.ts:482](https://github.com/unicorndomaingr/aepp-sdk-js-ts/blob/e06cc9f0/src/utils/errors.ts#L482)
