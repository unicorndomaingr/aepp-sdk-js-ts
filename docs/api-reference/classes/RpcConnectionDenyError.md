[api-reference](../README.md) / RpcConnectionDenyError

# Class: RpcConnectionDenyError
...
- [constructor](RpcConnectionDenyError.md#constructor)

### Properties

- [code](RpcConnectionDenyError.md#code)
- [data](RpcConnectionDenyError.md#data)
- [message](RpcConnectionDenyError.md#message)
- [name](RpcConnectionDenyError.md#name)
- [stack](RpcConnectionDenyError.md#stack)
- [code](RpcConnectionDenyError.md#code-1)
- [prepareStackTrace](RpcConnectionDenyError.md#preparestacktrace)
- [stackTraceLimit](RpcConnectionDenyError.md#stacktracelimit)

### Methods

- [toJSON](RpcConnectionDenyError.md#tojson)
- [captureStackTrace](RpcConnectionDenyError.md#capturestacktrace)
- [deserialize](RpcConnectionDenyError.md#deserialize)

## Constructors

### constructor

• **new RpcConnectionDenyError**(`data?`)
...
[src/utils/aepp-wallet-communication/schema.ts:112](https://github.com/unicorndomaingr/aepp-sdk-js-ts/blob/e06cc9f0/src/utils/aepp-wallet-communication/schema.ts#L112)
...
[src/utils/aepp-wallet-communication/schema.ts:111](https://github.com/unicorndomaingr/aepp-sdk-js-ts/blob/e06cc9f0/src/utils/aepp-wallet-communication/schema.ts#L111)
...
[src/utils/aepp-wallet-communication/schema.ts:110](https://github.com/unicorndomaingr/aepp-sdk-js-ts/blob/e06cc9f0/src/utils/aepp-wallet-communication/schema.ts#L110)
