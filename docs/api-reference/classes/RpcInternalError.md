[api-reference](../README.md) / RpcInternalError
...
- [constructor](RpcInternalError.md#constructor)

### Properties

- [code](RpcInternalError.md#code)
- [data](RpcInternalError.md#data)
- [message](RpcInternalError.md#message)
- [name](RpcInternalError.md#name)
- [stack](RpcInternalError.md#stack)
- [code](RpcInternalError.md#code-1)
- [prepareStackTrace](RpcInternalError.md#preparestacktrace)
- [stackTraceLimit](RpcInternalError.md#stacktracelimit)

### Methods

- [toJSON](RpcInternalError.md#tojson)
- [captureStackTrace](RpcInternalError.md#capturestacktrace)
- [deserialize](RpcInternalError.md#deserialize)
...
[src/utils/aepp-wallet-communication/schema.ts:141](https://github.com/unicorndomaingr/aepp-sdk-js-ts/blob/e06cc9f0/src/utils/aepp-wallet-communication/schema.ts#L141)
...
[src/utils/aepp-wallet-communication/schema.ts:140](https://github.com/unicorndomaingr/aepp-sdk-js-ts/blob/e06cc9f0/src/utils/aepp-wallet-communication/schema.ts#L140)
...
[src/utils/aepp-wallet-communication/schema.ts:139](https://github.com/unicorndomaingr/aepp-sdk-js-ts/blob/e06cc9f0/src/utils/aepp-wallet-communication/schema.ts#L139)
