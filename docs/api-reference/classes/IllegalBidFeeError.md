[api-reference](../README.md) / IllegalBidFeeError

# Class: IllegalBidFeeError
...
- [constructor](IllegalBidFeeError.md#constructor)

### Properties

- [message](IllegalBidFeeError.md#message)
- [name](IllegalBidFeeError.md#name)
- [stack](IllegalBidFeeError.md#stack)
- [prepareStackTrace](IllegalBidFeeError.md#preparestacktrace)
- [stackTraceLimit](IllegalBidFeeError.md#stacktracelimit)

### Methods

- [captureStackTrace](IllegalBidFeeError.md#capturestacktrace)

## Constructors

### constructor

• **new IllegalBidFeeError**(`message`)
...
[src/utils/errors.ts:496](https://github.com/unicorndomaingr/aepp-sdk-js-ts/blob/e06cc9f0/src/utils/errors.ts#L496)
